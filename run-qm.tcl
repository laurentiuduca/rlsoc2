...
read_verilog -sv "sdram-qm/af.v"
read_verilog -sv "sdram-qm/memoryqm.v"

read_verilog -sv "max7219.v"
read_verilog -sv "clkdivider.v"

read_verilog -sv "sd/sdspi_file_reader.v"
read_vhdl "sd/sd_spi.vhd"
read_verilog -sv "sd/sdspi_loader.v"
read_verilog -sv "sd/sdspi_reader.v"
read_verilog -sv "sd/sd.v"
